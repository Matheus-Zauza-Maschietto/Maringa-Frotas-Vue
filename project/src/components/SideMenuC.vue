    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="side-bar">
      <div class="offcanvas-header">
        ...
        <h5 class="offcanvas-title">
          <router-link :to="{name: 'home'}" style="text-decoration: none; color: white;">Maringa Frotas’s</router-link>
        </h5>
      ...
      <div class="offcanvas-body">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
          ...
          <li class="">
            <router-link :to="{name: 'menuCadastros'}" class="nav-link py-3 border-bottom border-top rounded-0" data-bs-toggle="tooltip" data-bs-placement="right">
              <font-awesome-icon icon="fa-solid fa-plus" class="icon bi pe-none" role="img"/>
              <span>Adicionar Cadastros</span>
            </router-link>
          </li>
          <li>
            <router-link :to="{name: 'menuRegistros'}" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right">
